 ...
 * from root OIL file lab04_ex2.oil
 *
...
/* Alarm a125msecV identifier */
#define a125msecV_id 2
CONST(AlarmType, AUTOMATIC) a125msecV = a125msecV_id;
...
#include "tpl_memmap.h"
tpl_stack_word TaskW_stack_zone[128/sizeof(tpl_stack_word)];
...
#define TaskW_STACK { TaskW_stack_zone, 128 }
...
CONST(tpl_task_activation_action, OS_CONST) a125msecV_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskV_id
...
CONST(tpl_alarm_static, OS_CONST) a125msecV_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a125msecV_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a125msecV_action
};
...
VAR(tpl_time_obj, OS_VAR) a125msecV_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a125msecV_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  125,
    /* date                         */  125,
