...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application two_tasks
...
includeDirs += ["-I", "../../../os"]
includeDirs += ["-I", "../../../debug"]
includeDirs += ["-I", "critical_section"]
cflags   += includeDirs
...
#--- OIL file
oilSourceList.append("critical_section.oil")
...
cSourceList.append(projfile.ProjectFile("critical_section.c"))
cSourceList.append(projfile.ProjectFile("tpl_os_hooks.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("critical_section/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("critical_section/tpl_os.c"))
