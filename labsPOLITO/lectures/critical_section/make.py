...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application two_tasks
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file critical_section.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=/home/teovu/trampoline/goil/templates/ critical_section.oil")
	sys.exit(1)
...
#----------------------------------------------------------------------
oilFile = "critical_section.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=posix/linux", "--templates=/home/teovu/trampoline/goil/templates/"]
...
#--- Add generated files
sourceList.append("critical_section/tpl_app_config.c")

sourceList.append("critical_section/tpl_os.c")
