 ...
 * from root OIL file critical_section.oil
 *
 ...
 */
/*-----------------------------------------------------------------------------
 * Task TaskLow descriptor
 */
#define APP_Task_TaskLow_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task TaskLow function prototype
 */

FUNC(void, OS_APPL_CODE) TaskLow_function(void);
#define APP_Task_TaskLow_STOP_SEC_CODE
 ...
 * Task TaskLow stack
 */
#define APP_Task_TaskLow_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word TaskLow_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_TaskLow_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK TaskLow_stack = {TaskLow_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define TaskLow_STACK &TaskLow_stack

/*
 * Task TaskLow context
 */
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT TaskLow_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define TaskLow_CONTEXT &TaskLow_context
...
/*
 * Resources used by task TaskLow
 *
 * Sem
 */

/*
 * Static descriptor of task TaskLow
 */
CONST(tpl_proc_static, OS_CONST) TaskLow_task_stat_desc = {
  /* context                  */  TaskLow_CONTEXT,
  /* stack                    */  TaskLow_STACK,
  /* entry point (function)   */  TaskLow_function,
  /* internal ressource       */  NULL,
  /* task id                  */  TaskLow_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task TaskLow
 */
VAR(tpl_proc, OS_VAR) TaskLow_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
#include "tpl_memmap.h"
/*
 * Task TaskHigh function prototype
 */

FUNC(void, OS_APPL_CODE) TaskHigh_function(void);
#define APP_Task_TaskHigh_STOP_SEC_CODE
 ...
 * Task TaskHigh stack
 */
#define APP_Task_TaskHigh_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word TaskHigh_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_TaskHigh_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK TaskHigh_stack = {TaskHigh_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define TaskHigh_STACK &TaskHigh_stack

/*
 * Task TaskHigh context
 */
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT TaskHigh_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define TaskHigh_CONTEXT &TaskHigh_context
...
/*
 * Resources used by task TaskHigh
 *
 * Sem
 */

/*
 * Static descriptor of task TaskHigh
 */
CONST(tpl_proc_static, OS_CONST) TaskHigh_task_stat_desc = {
  /* context                  */  TaskHigh_CONTEXT,
  /* stack                    */  TaskHigh_STACK,
  /* entry point (function)   */  TaskHigh_function,
  /* internal ressource       */  NULL,
  /* task id                  */  TaskHigh_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task TaskHigh
 */
VAR(tpl_proc, OS_VAR) TaskHigh_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
/*-----------------------------------------------------------------------------
 * Alarm one_msec_taskHigh descriptor
 *
 * This alarm does the activation of task TaskHigh
 */
...
CONST(tpl_task_activation_action, OS_CONST) one_msec_taskHigh_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) one_msec_taskHigh_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , one_msec_taskHigh_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&one_msec_taskHigh_action
};
...
VAR(tpl_time_obj, OS_VAR) one_msec_taskHigh_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&one_msec_taskHigh_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  80,
    /* date                         */  12,
...
/*-----------------------------------------------------------------------------
 * Alarm one_msec_taskLow descriptor
 *
 * This alarm does the activation of task TaskLow
 */
...
CONST(tpl_task_activation_action, OS_CONST) one_msec_taskLow_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskLow_id
...
CONST(tpl_alarm_static, OS_CONST) one_msec_taskLow_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , one_msec_taskLow_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&one_msec_taskLow_action
};
...
VAR(tpl_time_obj, OS_VAR) one_msec_taskLow_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&one_msec_taskLow_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  80,
    /* date                         */  10,
