...
#--- OIL file
oilSourceList.append("prodcons.oil")
...
cSourceList.append(projfile.ProjectFile("prodcons.c"))
cSourceList.append(projfile.ProjectFile("tpl_os_hooks.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("prodcons/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("prodcons/tpl_os.c"))
