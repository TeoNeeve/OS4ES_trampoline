...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file prodcons.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=/home/teovu/trampoline/goil/templates/ prodcons.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("prodcons/tpl_app_config.c")

sourceList.append("prodcons/tpl_os.c")
