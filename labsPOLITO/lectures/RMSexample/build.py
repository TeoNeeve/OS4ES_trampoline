...
#--- OIL file
oilSourceList.append("sched_demo.oil")
...
cSourceList.append(projfile.ProjectFile("sched_demo.c"))
cSourceList.append(projfile.ProjectFile("tpl_os_hooks.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("sched_demo/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("sched_demo/tpl_os.c"))
