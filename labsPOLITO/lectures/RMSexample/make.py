...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file sched_demo.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=/home/teovu/trampoline/goil/templates/ sched_demo.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("sched_demo/tpl_app_config.c")

sourceList.append("sched_demo/tpl_os.c")
