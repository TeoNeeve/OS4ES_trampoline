 ...
 *
 * Generated from application pp_demo
...
DeclareTask(Acq_AB);
DeclareTask(Acq_CD);
DeclareTask(TX_emergency);
DeclareTask(TX_normal);
DeclareTask(display);
DeclareTask(resume_operations);
DeclareTask(stop);
DeclareAlarm(Ticker);
DeclareAlarm(alarm_250ms);
DeclareAlarm(alarm_500ms);
DeclareAlarm(display_alarm_250ms);
DeclareAlarm(emergency_alarm_100ms);
DeclareAlarm(resume_450ms);
DeclareAlarm(stopper);
DeclareEvent(TX_go);
DeclareEvent(TX_kill);
