...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application pp_demo
...
#--- OIL file
oilSourceList.append("pp_demo.oil")
...
cSourceList.append(projfile.ProjectFile("pp_demo.c"))
cSourceList.append(projfile.ProjectFile("tpl_os_hooks.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("pp_demo/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("pp_demo/tpl_os.c"))
