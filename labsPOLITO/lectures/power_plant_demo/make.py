...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application pp_demo
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file pp_demo.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=/home/teovu/trampoline/goil/templates/ pp_demo.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("pp_demo/tpl_app_config.c")

sourceList.append("pp_demo/tpl_os.c")
