...
#--- Add generated files
cSourceList.append(projfile.ProjectFile("ex1/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("ex1/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("ex1/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("ex1/tpl_interrupts.c"))
