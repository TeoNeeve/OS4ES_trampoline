 ...
 *
 * OS data structure generated from application little_hal
...
/* Alarm TaskB50ms identifier */
#define TaskB50ms_id 1
CONST(AlarmType, AUTOMATIC) TaskB50ms = TaskB50ms_id;
...
CONST(tpl_task_activation_action, OS_CONST) TaskB50ms_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskB_id
...
CONST(tpl_alarm_static, OS_CONST) TaskB50ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , TaskB50ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&TaskB50ms_action
};
...
VAR(tpl_time_obj, OS_VAR) TaskB50ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&TaskB50ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  50,
    /* date                         */  1,
