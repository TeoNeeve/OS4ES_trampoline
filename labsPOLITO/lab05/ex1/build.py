...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application little_hal
#--- automatically generated by goil on Www Mmm dd hh:mm:ss yyyy
#--- from root OIL file lab05.oil
#---
...
#--- OIL file
oilSourceList.append("lab05.oil")
...
#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab05/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab05/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab05/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab05/tpl_interrupts.c"))
