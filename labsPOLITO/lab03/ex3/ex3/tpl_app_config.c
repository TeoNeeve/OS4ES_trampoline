...
CONST(tpl_appmode_mask, OS_CONST) tpl_task_app_mode[TASK_COUNT] = {
  ...
  1 /* task MsgInit : stdAppmode */ ,
  0 /* task stop :  */ 
};

CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm activateA : stdAppmode */ ,
  1 /* alarm activateB : stdAppmode */ ,
  1 /* alarm activateC : stdAppmode */ ,
  1 /* alarm activateMsgInit : stdAppmode */ ,
...
/* Task MsgInit identifier */
#define MsgInit_id 3
CONST(TaskType, AUTOMATIC) MsgInit = MsgInit_id;
...
/* Alarm activateA identifier */
#define activateA_id 0
CONST(AlarmType, AUTOMATIC) activateA = activateA_id;

/* Alarm activateB identifier */
#define activateB_id 1
CONST(AlarmType, AUTOMATIC) activateB = activateB_id;

/* Alarm activateC identifier */
#define activateC_id 2
CONST(AlarmType, AUTOMATIC) activateC = activateC_id;

/* Alarm activateMsgInit identifier */
#define activateMsgInit_id 3
CONST(AlarmType, AUTOMATIC) activateMsgInit = activateMsgInit_id;
...
/* Message CriticalMessage identifier */
#define CriticalMessage_id 0
CONST(MessageIdentifier, AUTOMATIC) CriticalMessage = CriticalMessage_id;

/*=============================================================================
 * Declaration of send messages IDs
 */

/* Message send_CriticalMessage identifier */
#define send_CriticalMessage_id 0
CONST(MessageIdentifier, AUTOMATIC) send_CriticalMessage = send_CriticalMessage_id;
...
/*-----------------------------------------------------------------------------
 * Task MsgInit descriptor
 */
#define APP_Task_MsgInit_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task MsgInit function prototype
 */

FUNC(void, OS_APPL_CODE) MsgInit_function(void);
#define APP_Task_MsgInit_STOP_SEC_CODE
 ...
 *
 */
#define APP_Task_MsgInit_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word MsgInit_stack_zone[128/sizeof(tpl_stack_word)];
#define APP_Task_MsgInit_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define MsgInit_STACK { MsgInit_stack_zone, 128 }

/*
 * Task MsgInit context
 */
avr_context MsgInit_int_context;
#define MsgInit_CONTEXT &MsgInit_int_context
...
/*
 * Resources used by task MsgInit
 *
 * INTERNAL_RES_SCHEDULER
 */

/*
 * Static descriptor of task MsgInit
 */
CONST(tpl_proc_static, OS_CONST) MsgInit_task_stat_desc = {
  /* context                  */  MsgInit_CONTEXT,
  /* stack                    */  MsgInit_STACK,
  /* entry point (function)   */  MsgInit_function,
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task MsgInit
 */
VAR(tpl_proc, OS_VAR) MsgInit_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
CONST(tpl_task_activation_action, OS_CONST) activateA_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) activateA_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , activateA_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&activateA_action
};
...
VAR(tpl_time_obj, OS_VAR) activateA_alarm_desc = {
...
CONST(tpl_task_activation_action, OS_CONST) activateB_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskB_id
...
CONST(tpl_alarm_static, OS_CONST) activateB_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , activateB_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&activateB_action
};
...
VAR(tpl_time_obj, OS_VAR) activateB_alarm_desc = {
...
CONST(tpl_task_activation_action, OS_CONST) activateC_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskC_id
...
CONST(tpl_alarm_static, OS_CONST) activateC_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , activateC_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&activateC_action
};
...
VAR(tpl_time_obj, OS_VAR) activateC_alarm_desc = {
...
/*-----------------------------------------------------------------------------
 * Alarm activateMsgInit descriptor
 *
 * This alarm does the activation of task MsgInit
 */
...
CONST(tpl_task_activation_action, OS_CONST) activateMsgInit_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  MsgInit_id
...
CONST(tpl_alarm_static, OS_CONST) activateMsgInit_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , activateMsgInit_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&activateMsgInit_action
};
...
VAR(tpl_time_obj, OS_VAR) activateMsgInit_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&activateMsgInit_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  0,
    /* date                         */  1,
...
CONSTP2VAR(tpl_time_obj, AUTOMATIC, OS_APPL_DATA)
  ...
  &activateA_alarm_desc,
  &activateB_alarm_desc,
  &activateC_alarm_desc,
  &activateMsgInit_alarm_desc,
  &stopper_alarm_desc
};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
...
/*-----------------------------------------------------------------------------
 * Action of message CriticalMessage
 */
/*-----------------------------------------------------------------------------
 * ALWAYS filter of message object CriticalMessage
 */
#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

tpl_noparam_filter_desc CriticalMessage_filter = {
...
/*-----------------------------------------------------------------------------
 * Static internal receiving queued message object CriticalMessage
 */
 
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

VAR(int, OS_VAR) CriticalMessage_buffer[1];
VAR(int, OS_VAR) CriticalMessage_last;

VAR(tpl_queue_dyn, OS_VAR) CriticalMessage_dyn_queue = {
...
CONST(tpl_internal_receiving_queued_mo, OS_CONST) CriticalMessage_message = {
  { /* data receiving mo struct   */
    ...
    /*  filter pointer          */  (tpl_filter_desc *)&CriticalMessage_filter
  },
  { /*  queue structure   */
    /*  pointer to the dynamic descriptor   */  &CriticalMessage_dyn_queue,
    /*  max size of the queue               */  1*sizeof(int),
    /*  element size of the queue           */  sizeof(int),
    /*  pointer to the buffer               */  (tpl_com_data *)CriticalMessage_buffer,
    /*  pointer to the last written value   */  (tpl_com_data *)&CriticalMessage_last
  }
};
...
tpl_receive_message_table[RECEIVE_MESSAGE_COUNT] = {
  (tpl_base_receiving_mo*)&CriticalMessage_message
};
...
/*-----------------------------------------------------------------------------
 * Static internal sending static message object send_CriticalMessage
 */
CONST(tpl_internal_sending_mo, OS_CONST) send_CriticalMessage_message = {
  { /* base message object       */
    /* sending function          */ tpl_send_static_internal_message
  },
  /* pointer to the receiving mo */ (tpl_base_receiving_mo *)&CriticalMessage_message
};
...
tpl_send_message_table[SEND_MESSAGE_COUNT] = {
  (tpl_base_sending_mo*)&send_CriticalMessage_message
};
