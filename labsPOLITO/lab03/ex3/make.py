...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file ex3.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=/home/teovu/trampoline/goil/templates/ ex3.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("ex3/tpl_app_config.c")

sourceList.append("ex3/tpl_dispatch_table.c")
sourceList.append("ex3/tpl_invoque.S")
sourceList.append("ex3/tpl_interrupts.c")
