...
cSourceList.append(projfile.ProjectFile("ex3.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("ex3/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("ex3/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("ex3/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("ex3/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary ex3_arduino.hex from ex3_arduino")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("ex3_arduino")
  postCommand.mCommand.append("ex3_arduino.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing ex3_arduino on avr/arduino/uno\033[0m")
